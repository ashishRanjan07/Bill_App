export const ImagePath = {
  ...
  carouselOne: require("../assets/image/carouselOne1.png"),
  ...
  mySubscription: require("../assets/image/mySubscription.png"),
  buySubscription: require("../assets/image/buySubscription.png"),
  history: require("../assets/image/history.png"),
  invoice: require("../assets/image/invoice.png"),
  offer: require("../assets/image/offer.png"),
  preBill: require("../assets/image/preBill.png"),
  rPrinter:require("../assets/image/rPrinter.png"),
  noInternet:require("../assets/image/noInternet.png"),
  printer2:require("../assets/image/printer3.jpg"),
  printer3:require("../assets/image/printer2.jpg"),
};
